...
public class companyMapView extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.map_inpd4shop);
    ...
    private void setUpMap() {
        ...
        mMap.addMarker(new MarkerOptions().position(latlong).title(company));
