 ...
 */
public class NearbBynew extends Fragment  implements LocationListener  {
    MapView mMapView;

    GoogleMap mGoogleMap;
    double mLatitude=0;
    double mLongitude=0;
    ImageButton atmButton,hospitalButton,beautySalonButton,gasStationButton,restaurantButton;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View v =inflater.inflate(R.layout.activity_nearby_new,container,false);
        atmButton =(ImageButton)v.findViewById(R.id.atm_button);
        hospitalButton= (ImageButton)v.findViewById(R.id.hospital_button);
        beautySalonButton =(ImageButton) v.findViewById(R.id.beauty_salon_button);
        gasStationButton = (ImageButton)v.findViewById(R.id.gas_station_button);
        restaurantButton =(ImageButton)v.findViewById(R.id.restaurant_button);
        ...
        if(status!= ConnectionResult.SUCCESS){ // Google Play Services are not available
            ...
            restaurantButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    sb.append("&key=AIzaSyCKAvwaDsXa2lHeyloAwsuzOR7qryL3dgE");
